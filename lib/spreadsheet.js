...
module.exports = {
    ...
    getClientDetailsArray: async function (organisationId) {
        ...
        try {
            ...
            let arr = await this.getCellsArray(organisationId, config[process.env.NODE_ENV][organisationId].formTargets.client.sheetIndex, [2, 3, 10, 11]);
    ...
    getJobDetailsArray: async function (organisationId) {
        ...
        try {
            ...
            let arr = await this.getCellsArray(organisationId, config[process.env.NODE_ENV][organisationId].formTargets.job.sheetIndex, [1, 2, 4, 9, 10]);
