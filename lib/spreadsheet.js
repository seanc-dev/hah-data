...
module.exports = {
    ...
    getCellsArray: function(organisationId, workSheetIndex, cellIndexArray){
        ...
        console.log("ss.getCellsArray config[process.env.NODE_ENV][organisationId]['targetSpreadsheetId']");
        console.log(config[process.env.NODE_ENV][organisationId]["targetSpreadsheetId"]);
        ...
        return new Promise((resolve, reject) => {
            ...
            doc.useServiceAccountAuth(creds, function (err) {
                ...
                doc.getCells(workSheetIndex, {
                    ...
                    console.log("ss.getCellsArray cells:")
                    console.log(cells);
