...
class DataObject {
    ...
    async updateDBObj() {
        ...
        // if this.data not populated, run this.getDataFromSheet
        try {
            if(this.data === {}) await this.getDataFromSheet().bind(this);
        } catch (err) {
            console.error(err);
        ...
        try {
            await this.getRowObject().bind(this);
        } catch (err) {
            console.error(err);
        ...
        // update database
        try {
            await this.updateSheetRow().bind(this);
    ...
    getDataFromSheet() {
        ...
        return ss.getRowsArrayDataOnly(this.organisationId, this.dimension, this.mapping, 1, this.dimension + "id = " + this._id)
            .then(function(result){
