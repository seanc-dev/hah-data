...
class Client extends DataObject {
    ...
    constructor(organisationId, id, formData) {
        ...
        this.jobWorksheetIndex = config[process.env.ENVIRONMENT][this.organisationId]["formTargets"]["job"].sheetIndex;
                ...
                .then(function(result){
                    ...
                    this.computeColumns()
                        ...
                        .catch((err) => {
                            ...
                            console.log("Error in compute columns return in Client constructor")
                            console.error(err);
    ...
    computeColumns() {
        ...
        return ss.getRowsArrayDataOnly(this.organisationId, "job", mapping["job"], 1, "clientid = " + this._id)
            .then(function (result) {
            ...
            .catch((err) => {
                ...
                console.log("Error in ss.getRowsArrayDataOnly return in Client.computeColumns")
                console.error(err);
    ...
    sumJobCost(arr) {
        ...
        let fieldName = "totalJobCost",
            APIName = lib.getSheetsAPIName(mapping["job"], fieldName);
