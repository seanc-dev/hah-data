...
module.exports = {
  ...
  getObjectFromKey: (orgShortName, dim, searchKey, searchValue, returnKey) => {
    let foundValue;
    try {
      obj = obj2 = mapping[orgShortName.toLowerCase()][dim].find((obj) => {
      ...
      console.log(
        `org: ${orgShortName}, dim: ${dim}, searchKey: ${searchKey}, searchValue: ${searchValue}, returnKey: ${returnKey}`
      );
      throw err;
    }
    return foundValue;
