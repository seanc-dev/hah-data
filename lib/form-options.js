        ...
        clientDetails: {
            ...
            fields: {
                ...
                cd_billingAddressSuburb: {
                    ...
                    fieldName: "billingAddressSuburb",
                    fieldType: "datalist",
                    values: ["", "Pukerua Bay", "Plimmerton", "Whitby", "Porirua", "Porirua East", "Tawa", "Johnsonville", "Churton Park", "Newlands ", "Khandallah", "Wellington CBD", "Te Aro", "Newtown", "Miramar", "Kilbirnie", "Mount Victoria", "Brooklyn", "Karori", "Wilton"],
                    readOnly: 0,
                    isRequired: 1
                },
                cd_billingAddressCity: {
                ...
                cd_territory: {
                    ...
                    fieldName: "territory",
                    fieldType: "select",
                    values: ["", "Northwest Wellington", "South Wellington", "Hutt Valley"],
                    readOnly: 0,
                    isRequired: 1
                },
                cd_customerDemographic: {
                ...
                cd_acquisitionChannel: {
                    ...
                    fieldName: "acquisitionChannel",
                    fieldType: "select",
                    values: ["", "Referral from Partner Business", "Word of Mouth", "Vehicle Signage", "Print Campaign (HAH TWL)", "Print Advertising (HAH Kapi Mana)", "Online Referral (HAH National - BAU)", "Facebook Advertising (HAH National - BAU)", "Facebook Advertising (HAH TWL - BAU)", "Facebook Campaign (HAH TWL)", "Other Marketing Campaign (HAH National)", "Flyer Drop", "Gift Voucher", "Sweet Louise Voucher"],
                    readOnly: 0,
                    isRequired: 1
                }
            }
            ...
            structure: [{
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        ["jd_costSubcontractor", "jd_costTipFees"],
                        ["jd_costOther"],
                        ["jd_hoursWorkedJames", "jd_hoursWorkedDarryl"],
                        ["jd_hoursWorkedWayne", "jd_hoursWorkedWarrick"],
                        ["jd_hoursWorkedVasco", "jd_hoursWorkedAotasiIose"],
                    ]
                },
                {
                    sectionTitle: "Job Feedback",
