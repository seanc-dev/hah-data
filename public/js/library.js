const lib = {
	...
	initialiseAppData: async function () {
		...
		console.log(`app data from server`);
		...
		document.appData.staffNames = staffNames;
	...
	getAccountNameValue: function () {
		...
		if (accountTypeVal === "Individual")
			return mainLastVal + ", " + mainFirstVal;
	...
	revealStatusMessage: function (dimension, alertType, alertTitle, alertText) {
		...
		let $statusDiv = $("#" + dimension + "DetailsForm")
